...
export class WebSocketApi extends Construct {
    ...
    addRoute(scope, routeKey, routeValue) {
        ...
        // Create route
        ///////////////////
        const returnResponse = !Fn.isInlineDefinition(routeValue) && !!routeValue.returnResponse
        ...
        console.log(`hit returnResponse ${routeKey} ${returnResponse}: ${JSON.stringify(routeValue)}`);
        ///////////////////
